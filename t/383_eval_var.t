...
# eval $var has eval "..."
$var = <<'END';
eval Char::Windows1252::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
if (eval Char::Windows1252::escape $var) {
...
$var = <<'END';
eval Char::Windows1252::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval Char::Windows1252::escape $var) {
...
# eval $var has eval '...'
$var = <<'END';
eval Char::Windows1252::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } '
END
if (eval Char::Windows1252::escape $var) {
...
# eval $var has eval q{...}
$var = <<'END';
eval Char::Windows1252::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
if (eval Char::Windows1252::escape $var) {
...
$var = <<'END';
eval Char::Windows1252::escape $var2
END
