...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Windows1252 software provides)

Windows1252 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Windows1252 software provide)
