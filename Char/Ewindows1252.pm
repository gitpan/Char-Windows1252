...
=item Chop string
  ...
  character chopped. The Char::Ewindows1252::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Ewindows1252::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Char::Ewindows1252::fc function for case-insensitive comparisons via Char::Windows1252
  software.
...
=item Fold case string
  ...
  New to Char::Windows1252 software, this function returns the full Unicode-like casefold of
...
=item Filename expansion (globbing)
  ...
  The Char::Ewindows1252::glob function grandfathers the use of whitespace to separate multiple
