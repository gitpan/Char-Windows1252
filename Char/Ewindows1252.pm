...
=item Make character
  ...
  set. For example, Char::Ewindows1252::chr(65) is "A" in either ASCII or Windows-1252, not Unicode,
  and Char::Ewindows1252::chr(0x82a0) is a Windows-1252 HIRAGANA LETTER A. For the reverse of
  Char::Ewindows1252::chr, use Char::Windows1252::ord.
