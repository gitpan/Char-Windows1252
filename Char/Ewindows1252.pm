...
sub import {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        ...
        for (@ARGV) {
            ...
            # has space
            if (/\A (?:$q_char)*? [ ] /oxms) {
                if (my @glob = Char::Ewindows1252::glob(qq{"$_"})) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
            ...
            # has wildcard metachar
                ...
                if (my @glob = Char::Ewindows1252::glob($_)) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
...
sub Char::Ewindows1252::fc(@);
sub Char::Ewindows1252::fc_();
sub Char::Ewindows1252::ignorecase;
sub Char::Ewindows1252::classic_character_class;
...
sub Char::Windows1252::getc(;*@);
sub Char::Windows1252::length(;$);
sub Char::Windows1252::substr($$;$$);
sub Char::Windows1252::index($$;$);
sub Char::Windows1252::rindex($$;$);
sub Char::Windows1252::escape(;$);

#
# Regexp work
#
BEGIN { CORE::eval q{ use vars qw(
    $Char::Windows1252::re_a
    $Char::Windows1252::re_t
    $Char::Windows1252::re_n
    $Char::Windows1252::re_r
) } }
...
${Char::Ewindows1252::dot}         = qr{(?:[^\x0A])};
${Char::Ewindows1252::dot_s}       = qr{(?:[\x00-\xFF])};
${Char::Ewindows1252::eD}          = qr{(?:[^0-9])};
...
# ${Char::Ewindows1252::eS}        = qr{(?:[^\x09\x0A    \x0C\x0D\x20])};
# ${Char::Ewindows1252::eS}        = qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])};
${Char::Ewindows1252::eS}          = qr{(?:[^\s])};

${Char::Ewindows1252::eW}          = qr{(?:[^0-9A-Z_a-z])};
${Char::Ewindows1252::eH}          = qr{(?:[^\x09\x20])};
${Char::Ewindows1252::eV}          = qr{(?:[^\x0A\x0B\x0C\x0D])};
${Char::Ewindows1252::eR}          = qr{(?:\x0D\x0A|[\x0A\x0D])};
${Char::Ewindows1252::eN}          = qr{(?:[^\x0A])};
${Char::Ewindows1252::not_alnum}   = qr{(?:[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Char::Ewindows1252::not_alpha}   = qr{(?:[^\x41-\x5A\x61-\x7A])};
${Char::Ewindows1252::not_ascii}   = qr{(?:[^\x00-\x7F])};
${Char::Ewindows1252::not_blank}   = qr{(?:[^\x09\x20])};
${Char::Ewindows1252::not_cntrl}   = qr{(?:[^\x00-\x1F\x7F])};
${Char::Ewindows1252::not_digit}   = qr{(?:[^\x30-\x39])};
${Char::Ewindows1252::not_graph}   = qr{(?:[^\x21-\x7F])};
${Char::Ewindows1252::not_lower}   = qr{(?:[^\x61-\x7A])};
${Char::Ewindows1252::not_lower_i} = qr{(?:[\x00-\xFF])};
${Char::Ewindows1252::not_print}   = qr{(?:[^\x20-\x7F])};
${Char::Ewindows1252::not_punct}   = qr{(?:[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Char::Ewindows1252::not_space}   = qr{(?:[^\s\x0B])};
${Char::Ewindows1252::not_upper}   = qr{(?:[^\x41-\x5A])};
${Char::Ewindows1252::not_upper_i} = qr{(?:[\x00-\xFF])};
${Char::Ewindows1252::not_word}    = qr{(?:[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Char::Ewindows1252::not_xdigit}  = qr{(?:[^\x30-\x39\x41-\x46\x61-\x66])};
${Char::Ewindows1252::eb}          = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Char::Ewindows1252::eB}          = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Char::Ewindows1252::foo" used only once: possible typo at here.
${Char::Ewindows1252::dot}         = ${Char::Ewindows1252::dot};
${Char::Ewindows1252::dot_s}       = ${Char::Ewindows1252::dot_s};
${Char::Ewindows1252::eD}          = ${Char::Ewindows1252::eD};
${Char::Ewindows1252::eS}          = ${Char::Ewindows1252::eS};
${Char::Ewindows1252::eW}          = ${Char::Ewindows1252::eW};
${Char::Ewindows1252::eH}          = ${Char::Ewindows1252::eH};
${Char::Ewindows1252::eV}          = ${Char::Ewindows1252::eV};
${Char::Ewindows1252::eR}          = ${Char::Ewindows1252::eR};
${Char::Ewindows1252::eN}          = ${Char::Ewindows1252::eN};
${Char::Ewindows1252::not_alnum}   = ${Char::Ewindows1252::not_alnum};
${Char::Ewindows1252::not_alpha}   = ${Char::Ewindows1252::not_alpha};
${Char::Ewindows1252::not_ascii}   = ${Char::Ewindows1252::not_ascii};
${Char::Ewindows1252::not_blank}   = ${Char::Ewindows1252::not_blank};
${Char::Ewindows1252::not_cntrl}   = ${Char::Ewindows1252::not_cntrl};
${Char::Ewindows1252::not_digit}   = ${Char::Ewindows1252::not_digit};
${Char::Ewindows1252::not_graph}   = ${Char::Ewindows1252::not_graph};
${Char::Ewindows1252::not_lower}   = ${Char::Ewindows1252::not_lower};
${Char::Ewindows1252::not_lower_i} = ${Char::Ewindows1252::not_lower_i};
${Char::Ewindows1252::not_print}   = ${Char::Ewindows1252::not_print};
${Char::Ewindows1252::not_punct}   = ${Char::Ewindows1252::not_punct};
${Char::Ewindows1252::not_space}   = ${Char::Ewindows1252::not_space};
${Char::Ewindows1252::not_upper}   = ${Char::Ewindows1252::not_upper};
${Char::Ewindows1252::not_upper_i} = ${Char::Ewindows1252::not_upper_i};
${Char::Ewindows1252::not_word}    = ${Char::Ewindows1252::not_word};
${Char::Ewindows1252::not_xdigit}  = ${Char::Ewindows1252::not_xdigit};
${Char::Ewindows1252::eb}          = ${Char::Ewindows1252::eb};
${Char::Ewindows1252::eB}          = ${Char::Ewindows1252::eB};
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $fc = Char::Ewindows1252::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
sub Char::Ewindows1252::classic_character_class {
    ...
    return {
        '\D' => '${Char::Ewindows1252::eD}',
        '\S' => '${Char::Ewindows1252::eS}',
        '\W' => '${Char::Ewindows1252::eW}',
        '\d' => '[0-9]',
        ...
        '\H' => '${Char::Ewindows1252::eH}',
        '\V' => '${Char::Ewindows1252::eV}',
        '\h' => '[\x09\x20]',
        '\v' => '[\x0A\x0B\x0C\x0D]',
        '\R' => '${Char::Ewindows1252::eR}',
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Ewindows1252::not_lower_i}',
                '[:^upper:]'  => '${Char::Ewindows1252::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Char::Ewindows1252::not_alnum}',
                '[:^alpha:]'  => '${Char::Ewindows1252::not_alpha}',
                '[:^ascii:]'  => '${Char::Ewindows1252::not_ascii}',
                '[:^blank:]'  => '${Char::Ewindows1252::not_blank}',
                '[:^cntrl:]'  => '${Char::Ewindows1252::not_cntrl}',
                '[:^digit:]'  => '${Char::Ewindows1252::not_digit}',
                '[:^graph:]'  => '${Char::Ewindows1252::not_graph}',
                '[:^lower:]'  => '${Char::Ewindows1252::not_lower}',
                '[:^print:]'  => '${Char::Ewindows1252::not_print}',
                '[:^punct:]'  => '${Char::Ewindows1252::not_punct}',
                '[:^space:]'  => '${Char::Ewindows1252::not_space}',
                '[:^upper:]'  => '${Char::Ewindows1252::not_upper}',
                '[:^word:]'   => '${Char::Ewindows1252::not_word}',
                '[:^xdigit:]' => '${Char::Ewindows1252::not_xdigit}',
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Ewindows1252::uc($char);
                        my $fc = Char::Ewindows1252::fc($char);
                        if ($uc eq $fc) {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Ewindows1252::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Ewindows1252::fc($_[0]) =~ /\A $pattern \z/xms };
...
#
sub Char::Ewindows1252::PREMATCH {
    return $`;
}
...
#
sub Char::Ewindows1252::POSTMATCH {
    return $';
}
...
sub Char::Windows1252::getc(;*@) {
    ...
    croak 'Too many arguments for Char::Windows1252::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Char::Ewindows1252::dot_s} \z/oxms) {
...
my $qq_substr  = qr{(?: Char::Windows1252::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
sub Char::Windows1252::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::Windows1252::escape_token();
    }
...
#
sub Char::Windows1252::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Ewindows1252::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ewindows1252::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Ewindows1252::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ewindows1252::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Ewindows1252::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ewindows1252::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Char::Ewindows1252::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while \s* \( \s* glob \s* \) /oxgc) {
        return 'while ($_ = Char::Ewindows1252::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while \s* \( \s* glob \b /oxgc) {
        return 'while ($_ = Char::Ewindows1252::glob';
    }
...
# subroutines of package Char::Ewindows1252
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::Windows1252::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::Windows1252::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::Windows1252::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::Windows1252::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Windows1252::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::Windows1252::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Windows1252::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::fc';         }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ewindows1252::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Ewindows1252::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Ewindows1252::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Ewindows1252::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Ewindows1252::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Ewindows1252::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Ewindows1252::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Ewindows1252::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Ewindows1252::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Ewindows1252::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Ewindows1252::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Ewindows1252::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Ewindows1252::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Ewindows1252::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Ewindows1252::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Ewindows1252::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Ewindows1252::split' . $e . qq     {" "};  }
...
# <WILDCARD> --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'Char::Ewindows1252::glob("' . $1 . '")';
    }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Ewindows1252::PREMATCH()]}
            ...
            $e_string .= q{Char::Ewindows1252::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Ewindows1252::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Ewindows1252::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Ewindows1252::POSTMATCH()]}
            ...
            $e_string .= q{Char::Ewindows1252::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Ewindows1252
        ...
        elsif ($string =~ /\G \b Char::Windows1252::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Windows1252::eval \b                                /oxgc) { $e_string .= 'eval Char::Windows1252::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Ewindows1252::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Windows1252::index \b                               /oxgc) { $e_string .= 'Char::Windows1252::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Ewindows1252::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Windows1252::rindex \b                              /oxgc) { $e_string .= 'Char::Windows1252::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Ewindows1252::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ewindows1252::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ewindows1252::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ewindows1252::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ewindows1252::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ewindows1252::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ewindows1252::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ewindows1252::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Ewindows1252::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Ewindows1252::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Ewindows1252::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Ewindows1252::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Ewindows1252::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Ewindows1252::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Ewindows1252::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Ewindows1252::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Ewindows1252::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
# <WILDCARD>   --- glob
            ...
            $e_string .= 'Char::Ewindows1252::glob("' . $1 . '")';
        }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Ewindows1252::dot_s}';
        }
        else {
            return '${Char::Ewindows1252::dot}';
        }
    }
    else {
        return Char::Ewindows1252::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Char::Ewindows1252::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Char::Ewindows1252::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Char::Ewindows1252::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Char::Ewindows1252::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Char::Ewindows1252::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Char::Ewindows1252::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Char::Ewindows1252::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Char::Ewindows1252::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Char::Ewindows1252::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Ewindows1252::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Ewindows1252::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Ewindows1252::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Ewindows1252::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Ewindows1252::uc($char[$i]) ne Char::Ewindows1252::fc($char[$i]))) {
            if (CORE::length(Char::Ewindows1252::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Ewindows1252::uc($char[$i])       . Char::Ewindows1252::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Ewindows1252::uc($char[$i]) . '|' . Char::Ewindows1252::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ewindows1252::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ \s* 0 \s* \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Ewindows1252::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ewindows1252::ignorecase(Char::Ewindows1252::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ewindows1252::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Ewindows1252::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ewindows1252::ignorecase(Char::Ewindows1252::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ewindows1252::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Ewindows1252::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ewindows1252::ignorecase(Char::Ewindows1252::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ewindows1252::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::Windows1252::re_t=%s; while($Char::Windows1252::re_t =~ %s){%s local $^W=0; local $Char::Windows1252::re_r=%s; %s$Char::Windows1252::re_t="$`$Char::Windows1252::re_r$'"; pos($Char::Windows1252::re_t)=length "$`$Char::Windows1252::re_r"; } return $Char::Windows1252::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::Windows1252::re_r=CORE::eval $Char::Windows1252::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::Windows1252::re_r=%s; %s"%s$Char::Windows1252::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::Windows1252::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::Windows1252::re_r=%s; %s%s="$`$Char::Windows1252::re_r$'"; pos(%s)=length "$`$Char::Windows1252::re_r"; $Char::Windows1252::re_n++} return %s$Char::Windows1252::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::Windows1252::re_r=%s; %s%s="%s$Char::Windows1252::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::Windows1252::re_r=%s; %s%s="%s$Char::Windows1252::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::Windows1252::re_r=CORE::eval $Char::Windows1252::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ewindows1252::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Ewindows1252::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Ewindows1252::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  use Char::Ewindows1252;
    ...
    Char::Ewindows1252::fc(...);
    Char::Ewindows1252::fc_;
...
This module has run-time routines for use Char::Windows1252 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::Windows1252 software and not
...
=item Split string
  ...
  at all, Char::Ewindows1252::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Ewindows1252::split(//,  $word);
  @fields = Char::Ewindows1252::split(/:/, $line);
  @words  = Char::Ewindows1252::split(" ", $paragraph);
  @lines  = Char::Ewindows1252::split(/^/, $buffer);
  ...
  print join(":" => Char::Ewindows1252::split(/ */, "hi there"));
  ...
  Char::Ewindows1252::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Ewindows1252::split(/:/, $_, 3);
  ...
  Char::Ewindows1252::split(/([-,])/, "1-10,20");
  ...
  splits on whitespace just as Char::Ewindows1252::split with no arguments does. Thus,
  Char::Ewindows1252::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Ewindows1252::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Ewindows1252::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Ewindows1252::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Ewindows1252::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Ewindows1252::split is join, except that join can only join with the
...
=item Transliteration
  ...
  print Char::Ewindows1252::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'
...
=item Chop string
  ...
  character chopped. The Char::Ewindows1252::chop subroutine is used primary to remove the newline
  ...
  since Char::Ewindows1252::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Ewindows1252::chop a literal, only a variable. If you Char::Ewindows1252::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Ewindows1252::chop(@lines);

  You can Char::Ewindows1252::chop anything that is an lvalue, including an assignment:

  Char::Ewindows1252::chop($cwd = `pwd`);
  Char::Ewindows1252::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Ewindows1252::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Ewindows1252::chop returns the character
  ...
  In the most general case, Char::Ewindows1252::chop can be expressed using substr:

  $last_code = Char::Ewindows1252::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Ewindows1252::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Ewindows1252::chop;
...
=item Index string
  ...
  $byte_pos = Char::Ewindows1252::index($string,$substr,$byte_offset);
  $byte_pos = Char::Ewindows1252::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Ewindows1252::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Ewindows1252::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Ewindows1252::rindex($string,$substr);

  This subroutine works just like Char::Ewindows1252::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Ewindows1252::index).
  ...
  while (($byte_pos = Char::Windows1252::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  You can use the Char::Ewindows1252::fc subroutine for case-insensitive comparisons via Char::Windows1252
  software.
...
=item Upper case string
  ...
  in interpolated strings. For titlecase, use Char::Ewindows1252::ucfirst instead.
...
=item Upper case first character of string
  ...
  $titlecase = Char::Ewindows1252::ucfirst(substr($word,0,1)) . Char::Ewindows1252::lc(substr($word,1));
  ...
  $do_not_use = Char::Ewindows1252::ucfirst(Char::Ewindows1252::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Ewindows1252::fc($string);
  $fc = Char::Ewindows1252::fc_;

  New to Char::Windows1252 software, this subroutine returns the full Unicode-like casefold of
  ...
  Char::Ewindows1252::fc($a) eq Char::Ewindows1252::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::Windows1252 software has always used casefolding semantics for
...
=item Make character
  ...
  that $code in the character set. For example, Char::Ewindows1252::chr(65) is "A" in either
  ASCII or Windows-1252, not Unicode. For the reverse of Char::Ewindows1252::chr, use Char::Windows1252::ord.
...
=item Filename expansion (globbing)
  ...
  The Char::Ewindows1252::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Ewindows1252::glob('"*e f*"');
  @spacies = Char::Ewindows1252::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Ewindows1252::glob("'*${var}e f*'");
  @spacies = Char::Ewindows1252::glob(qq("*${var}e f*"));
