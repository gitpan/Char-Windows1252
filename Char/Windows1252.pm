...
BEGIN { require Char::Ewindows1252; }
...
written by Windows-1252.

Perl is optimized for problems which are about 90% working with text and about
10% everything else. But this "text" means US-ASCII text, and popular Windows-1252
...
Perl3 or later can treat Windows-1252.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::Windows1252 software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw Windows-1252, Doesn't use UTF8 flag like JPerl
...
Definitions in Char/Ewindows1252.pm.
  ...
  After                    Definition
  ---------------------------------------------------------------------------------------------------------------------------------------------------------
  ${Char::Ewindows1252::anchor}         qr{\G(?:[\x00-\xFF])*?}
  ...
  ${Char::Ewindows1252::not_space}      qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])}
...
It has already been achieved by Windows-1252 designed for combining with
...
Contrasting is Encode module and describing "use Char::Windows1252;" on this software,
