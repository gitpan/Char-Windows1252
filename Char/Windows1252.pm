...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Ewindows1252::function_ord     = 'Char::Windows1252::ord'     if /\A ord \z/oxms;
                    $Char::Ewindows1252::function_ord_    = 'Char::Windows1252::ord_'    if /\A ord \z/oxms;
                    $Char::Ewindows1252::function_reverse = 'Char::Windows1252::reverse' if /\A reverse \z/oxms;
                    $Char::Ewindows1252::function_getc    = 'Char::Windows1252::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Windows1252::escape();
...
=head1 Calling 'Char::Ewindows1252::ignorecase()' (Char::Windows1252 software provides)

Char::Windows1252 software applies calling 'Char::Ewindows1252::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Windows1252 software provides)

Char::Windows1252 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Windows1252 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Windows1252 software provides)

Char::Windows1252 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Windows1252 software and
