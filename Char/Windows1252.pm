...
Let's start with a bit of history: jperl 4.019+1.3 introduced Windows-1252 support.
...
In this country, Windows-1252 is widely used on mainframe I/O, the personal computer,
and the cellular phone. This software treats Windows-1252 directly, but doesn't treat
