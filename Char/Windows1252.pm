...
######################################################################
#
# Char::Windows1252 - Source code filter to Windows-1252 script
#
...
sub Char::Windows1252::escape_script {
    ...
    if (/^ use Char::Ewindows1252(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Ewindows1252 %s;\n%s", $Char::Ewindows1252::VERSION, $use_re_eval); # require run-time routines version
...
Char::Windows1252 - Source code filter to escape Windows-1252

=head1 SYNOPSIS

  use Char::Windows1252;
  use Char::Windows1252 version;         --- require version
...
better, fitter Char::Windows1252.
