...
and the cellular phone. This software treats Windows-1252 directly. Therefor there is
not UTF8 flag.
...
=head1 Perl5.6 Emulation On perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Char/Ewindows1252.pm
  --------------------------------------------------------------------
  binmode(...);   Char::Ewindows1252::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Char::Ewindows1252::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  open(FH, "<:crlf:encoding(Char::Windows1252)", $path) or die "can't open $path: $!";
